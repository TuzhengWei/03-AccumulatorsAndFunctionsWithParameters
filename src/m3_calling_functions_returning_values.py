...
def run_test_sum_of_digits():
    ...
    # Test 2:
    expected = 23
    answer = sum_of_digits(698)
    print('Test 2 expected:',expected)
    print('    actual:     ',    answer)

    # Test 3:
    expected = 45
    answer = sum_of_digits(778)
    print('Test 3 expected:', expected)
    print('  actual:       ', answer)

    # Test 3：
    expected = 10
    answer = sum_of_digits(998)
...
def digits_in_cube(n):
    ...
    number =n**3
    sum_of_digits_in_cube = sum_of_digits(number)
    return sum_of_digits_in_cube
...
def run_test_digits_in_power():
    ...
    print('Testing 1 expected:', expected)
    print('    actual:', answer)


    expected = 10
    answer = digits_in_power(5,2)
    print('Testing 2 expected:', expected)
    print('  actual:', answer)

    expected = 13
    answer = digits_in_power(7,2)
    print('Testing 3 expected:', expected)
    print('  actual:', answer)
...
def digits_in_power(n, k):
    ...
    number = n**k
    sum_of_digits_in_power = sum_of_digits(number)
    return sum_of_digits_in_power
...
def fancy_sums_of_digits(n):
    ...
    fancy_sums = digits_in_power(X,Y)
    return fancy_sums
# ----------------------------------------------------------------------
