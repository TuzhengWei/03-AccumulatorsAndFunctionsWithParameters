...
def main():
    ...
    run_test_better_draw_circles(10)
    run_test_even_better_draw_circles(10)
...
#  In a previous exercise, YOU implem-ented very similar functions.
#
...
def run_test_even_better_draw_circles(n):

    
    even_better_draw_circles(n)
